# Generated by Django 5.2.4 on 2025-09-02 15:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Vegetables', 'Vegetables'), ('Fruits', 'Fruits'), ('Seasoning', 'Seasoning'), ('Diary', 'Diary'), ('Meaty', 'Meaty'), ('Sweets', 'Sweets'), ('Baking', 'Baking'), ('Sauces', 'Sauces'), ('Oils', 'Oils'), ('Basic', 'Basic'), ('Fluids', 'Fluids')], max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Recipe',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefix', models.CharField(blank=True, choices=[('', ''), ('G', 'G'), ('Ml', 'Ml'), ('Table Spoon', 'Table Spoon'), ('Tea Spoon', 'Tea Spoon')], max_length=20)),
